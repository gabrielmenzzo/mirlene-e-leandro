  ...
  return (
    <>
      ...
      <main className="min-h-screen relative overflow-hidden flex flex-col items-center">
        ...
        {/* Hero Section */}
        <section className="w-full max-w-4xl mx-auto px-6 pt-12 pb-8 md:pb-20 flex flex-col items-center text-center relative z-10">
          <PolaroidGallery />
          <Logo className="mb-8" />
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0 mb-10 md:mb-16 text-wedding-text font-lato">
        ...
        {/* Our Story Section */}
        <OurStory hasUserInteracted={hasEntered} />
